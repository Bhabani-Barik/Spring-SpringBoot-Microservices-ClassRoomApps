...
public class MySQLEmployeeDAOImpl implements IEmployeeDAO {
	...
	public MySQLEmployeeDAOImpl(DataSource ds) {
		System.out.println("MysqlEmployeeDAOImpl:: 1-param constructor");
		this.ds = ds;
	}

	public MySQLEmployeeDAOImpl(DataSource ds, int x) {
		System.out.println("MysqlEmployeeDAOImpl:: 2-param constructor");
		this.ds = ds;
	}
	...
	public List<Employee> getEmpsByDesgs(String desg1, String desg2, String desg3) throws Exception {
		...
		try (// get pooled jdbc con
			...
			try (ResultSet rs = ps.executeQuery()) {
				// copy the records of ResultSet object to List collection as the Java Bean
				// class objs
