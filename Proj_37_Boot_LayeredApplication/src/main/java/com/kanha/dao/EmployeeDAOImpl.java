...
public class EmployeeDAOImpl implements IEmployeeDAO {
	...
	@Autowired
	private DataSource datasource; // The IOC container injects HikariDataSource object that comes through
									// AutoConfiguration
		...
		try (Connection con = datasource.getConnection(); // gives Pooled JDBC con object // get pooled connection
			...
			try ( // Execute the SQL Query
				...
				while (rs.next()) {
					...
					// Copy each record values to Java Bean Class Object [i.e- Employee Class
					// Object]
