...
import com.kanha.service.IActorMgmtService;
import com.kanha.vo.ActorVO;
...
public class ActorOperationsController {
	...
	public  String showHome() {
		System.out.println("ActorOperationsController.showHome() (home method4)");
		//return LVN
		return  "welcome";
	}
	...
	public    String  showReport(Map<String,Object> map) {
		System.out.println("ActorOperationsController.showReport() (report method4)");
		//use Service 
	...
	public  String  editActor(@ModelAttribute("actor") ActorVO actorVO,
			                                    RedirectAttributes  attrs) {
		//use service
